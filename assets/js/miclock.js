...
// https://css-tricks.com/building-progress-ring-quickly/
 ...
 function displayStandardTime(timeid) {
 ...
 function displayMitime(mitimeid) {
   // Compose the string for display
 ...
 function displayMiclock(miclocksvgid) {      
   if (mi != 0) {
...
function miclock(miclocksvgid, mitimeid, timeid) {
    getStandardTime();
